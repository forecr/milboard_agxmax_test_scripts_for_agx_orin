...
DIGITAL_IO_CH1=`gpiofind "DIGITAL_IO_CH1"`

read -p "Input or Output (i/o): " IO_CHOICE
case $IO_CHOICE in
	[Ii]* )
		watch -n 0.1 gpioget $DIGITAL_IO_CH1
		;;
	[Oo]* )
		echo "DIGITAL_IO_CH1 OFF"
		run_gpioset_out $DIGITAL_IO_CH1 0
		sleep $sleep_time
		echo "DIGITAL_IO_CH1 ON"
		run_gpioset_out $DIGITAL_IO_CH1 1
		sleep $sleep_time
		echo "DIGITAL_IO_CH1 OFF"
		run_gpioset_out $DIGITAL_IO_CH1 0
		sleep $sleep_time
