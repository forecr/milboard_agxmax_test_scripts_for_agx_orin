...
DIGITAL_IO_CH7=`gpiofind "DIGITAL_IO_CH7"`

read -p "Input or Output (i/o): " IO_CHOICE
case $IO_CHOICE in
	[Ii]* )
		watch -n 0.1 gpioget $DIGITAL_IO_CH7
		;;
	[Oo]* )
		echo "DIGITAL_IO_CH7 OFF"
		run_gpioset_out $DIGITAL_IO_CH7 0
		sleep $sleep_time
		echo "DIGITAL_IO_CH7 ON"
		run_gpioset_out $DIGITAL_IO_CH7 1
		sleep $sleep_time
		echo "DIGITAL_IO_CH7 OFF"
		run_gpioset_out $DIGITAL_IO_CH7 0
		sleep $sleep_time
